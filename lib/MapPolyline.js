...
class MapPolyline extends React.Component {
    ...
    startPolylineAnimation(staticColor, animationDuration = 500) {
        if (this.polyline.current) {
            MapPolylineNativeComponent_1.Commands.startPolylineAnimation(this.polyline.current, staticColor, animationDuration);
        }
    }
    render() {
